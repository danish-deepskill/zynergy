...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_category" AS ENUM('umkm', 'personal', 'bisnis-lokal', 'sekolah', 'company-profile', 'jasa');
  CREATE TYPE "public"."enum_leads_features" AS ENUM('landing-page', 'toko-online', 'blog', 'booking', 'whatsapp', 'seo-lokal', 'multi-bahasa', 'lainnya');
  CREATE TYPE "public"."enum_leads_business_type" AS ENUM('umkm', 'personal', 'bisnis-lokal', 'sekolah', 'company-profile', 'lainnya');
  CREATE TYPE "public"."enum_leads_budget" AS ENUM('lt-500k', '500k-1jt', '1-3jt', 'gt-3jt', 'unknown');
  CREATE TYPE "public"."enum_leads_deadline" AS ENUM('asap', '1-2minggu', '1bulan', 'fleksibel');
  CREATE TYPE "public"."enum_leads_status" AS ENUM('baru', 'dihubungi', 'deal', 'tidak-lanjut');
  CREATE TABLE "posts" (
  ...
  CREATE TABLE "leads_features" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_leads_features",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "leads" (
  	...
  	"email" varchar,
  	"business_type" "enum_leads_business_type",
  	"budget" "enum_leads_budget",
  	"deadline" "enum_leads_deadline",
  	"message" varchar,
  ...
  ALTER TABLE "leads_features" ADD CONSTRAINT "leads_features_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."leads"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "leads_features_order_idx" ON "leads_features" USING btree ("order");
  CREATE INDEX "leads_features_parent_idx" ON "leads_features" USING btree ("parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "leads_features" CASCADE;
  ...
  DROP TYPE "public"."enum_leads_features";
  DROP TYPE "public"."enum_leads_business_type";
  DROP TYPE "public"."enum_leads_budget";
  DROP TYPE "public"."enum_leads_deadline";
